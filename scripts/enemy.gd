...
var body_color := Color(0.28, 0.12, 0.10)
var eye_color := Color(0.78, 0.07, 0.035)
...
func _build_body() -> void:
	...
	_add_part("Torso", Vector3(0.66, 0.94, 0.38), Vector3(0, 1.03, 0), body_color)
	_add_part("LeftLeg", Vector3(0.23, 0.78, 0.24), Vector3(-0.17, 0.43, 0), body_color.darkened(0.55))
	_add_part("RightLeg", Vector3(0.23, 0.78, 0.24), Vector3(0.17, 0.43, 0), body_color.darkened(0.55))
	_add_part("LeftArm", Vector3(0.19, 0.78, 0.22), Vector3(-0.45, 1.03, -0.03), body_color.lightened(0.08))
	_add_part("RightArm", Vector3(0.19, 0.78, 0.22), Vector3(0.45, 1.03, -0.03), body_color.lightened(0.08))
	...
	head_mat.albedo_color = body_color.lightened(0.04)
